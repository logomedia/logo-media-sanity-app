  ...
  return (
    <div id="navigation">
            <div className={styles.navContainer}>
              ...
              <div className={styles.menuIcon} onClick={setToggle}>
                <HamburgerIcon className={styles.hamburgerIcon} />
              </div>
            </div>
            <div className={  isActive ? styles.menuContainerOpen : styles.menuContainer} >
              <div className={styles.close} onClick={setToggle}>
              ...
              <nav>
                  <ul className={styles.navItems}>
                    {navItems &&
                      navItems.map((item) => {
                        const {slug, title, _id} = item
                        const isLinkActive = slugParamToPath(router.query.slug) === slug.current
                        return (
                          <li key={_id} className={styles.navItem}>
                            <Link href={getPathFromSlug(slug.current)}>
                              <a data-is-active={isLinkActive ? 'true' : 'false'} aria-current={isLinkActive}>
                                {title}
                              </a>
                            </Link>
                          </li>
